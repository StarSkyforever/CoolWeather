...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化控件
        bindPicImag=(ImageView) findViewById(R.id.bing_pig_img);
        ...
        if(bingPic!=null)
        {
            Glide.with(this).load(bingPic).into(bindPicImag);
        }else
        {
            loadBingPic();
        }
    ...
    private void loadBingPic() {
        String requesBindPic="http://guolin.tech/api/bing_pic";
        HttpUtil.sendOkHttpRequest(requesBindPic,new Callback(){
            @Override
            public void onResponse(Call call,Response response)throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(bingPic).into(bindPicImag);
                    }
                });
            }
